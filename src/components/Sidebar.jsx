    ...
    return (
        <div className='w-[10%] bg-neutral-900'>
            <div className='w-full text-white flex flex-col items-center justify-center py-5 gap-5'>
                ...
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-neutral-600">
                    <IoPersonSharp className="text-white text-2xl" onClick={() => navigate("/about")}/>
                </span>
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-neutral-600">
                    <MdOutlineWorkOutline className="text-white text-2xl" onClick={() => navigate("/projects")}/>
                </span>
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-neutral-600">
                    <IoIosMail className="text-white text-2xl" onClick={() => navigate("/mail")}/>
                </span>
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-neutral-600">
