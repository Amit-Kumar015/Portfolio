...
function About() {
  return (
    <div className='w-3xl bg-neutral-800 flex flex-col justify-center text-white'>
      ...
      <br />
      <p>Connecting with people and collaborating on innovative projects inspires me to grow and create impactful solutions.</p>
      <br />
      <p>Learning and exploring new technologies always excites me.</p>
    </div>
  )
}
